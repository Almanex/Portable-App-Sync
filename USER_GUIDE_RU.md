...
- **Решение**: Утилита Winget предустановлена в Windows 11 и последних версиях Windows 10. Если она отсутствует:
  ...
  3. В качестве альтернативы скачайте последний пакет `.msixbundle` из официального [репозитория на GitHub](https://github.com/microsoft/winget-cli/releases) и запустите его.
