...
- 🎨 **Современный Fluent UI** — интерфейс стилизован с использованием WPF-UI 4.3.0, поддерживается автоматическое переключение светлой/темной тем и системное оформление
...
- **WPF и WPF-UI (v4.3.0)** — дизайн-система Fluent и современные элементы интерфейса
