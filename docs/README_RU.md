...
Подробные руководства по использованию приложения:
- **[Быстрый старт](QUICKSTART_RU.md)**: краткое руководство по запуску приложения.
- **[Руководство пользователя](GUIDE_RU.md)**: подробное руководство по фильтрации, режимам экспорта, гибридному оффлайн-режиму и решению проблем.
